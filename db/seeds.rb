...
user10.photo.attach(io: file10, filename: 'ry.png', content_type: 'image/png')
...
ngo8 = Ngo.create(name: "Cultural Center MiMusica", phone: "+188099298", description: "Supporting our root causes with all our energy and effort", user: user8)
...
project1= Project.create(title: "Teaching children in Gracia", hours_per_week: 8, address: "Carrer de Sant Agustí, 14, 08012 Barcelona, Spain", description: "We need 7-10 people that support our school in teaching young children English skills as well as spending time with them in the afternoon." , capacity: 10 , category: "Children" , ngo: ngo1)
file31 = File.open("app/assets/images/projects/teaching.jpg")
project1.photo.attach(io: file31, filename: 'img1.jpg', content_type: 'image/jpg')


project2= Project.create(title: "Supporting elderly care", hours_per_week: 5, address: "Carrer de Provença, 480, 08025 Barcelona, Spain", description: "We look for up to 15 people to support our daily activities.
...
project2.photo.attach(io: file32, filename: 'img2.jpg', content_type: 'image/jpg')

project3= Project.create(title: "Food delivery for elderly people", hours_per_week: 5, address: "Carrer de Lepant, 150, 08013 Barcelona, Spain", description: "We look for volunteers to bring food to elderly people and spend time with them in the afternoon. 5-7 people are needed with around 5 hours time per week." , capacity: 7 , category: "Elderly Care" , ngo: ngo3)
file33 = File.open("app/assets/images/projects/elderly-delivery.jpg")
project3.photo.attach(io: file33, filename: 'img3.jpg', content_type: 'image/jpg')


project4= Project.create(title: "Trees for a Green Future", hours_per_week: 20, address: "Carrer de Rossend Nobas, 31, 08018 Barcelona, Spain", description: "We look for volunteers to help us make Barcelona green again. In 2019 we plated over 2000 trees in the whole city that need to be watered and taken care of. Join with your team and let's grow good together." , capacity: 25 , category: "Environment" , ngo: ngo4)
file34 = File.open("app/assets/images/projects/trees.jpg")
project4.photo.attach(io: file34, filename: 'img4.jpg', content_type: 'image/jpg')

project5= Project.create(title: "City Cleaning Squad", hours_per_week: 20, address: "Plaça de Catalunya, 08002 Barcelona, Spain", description: "We look for volunteers to help us keep Barcelona a clean city. In the evenings and weekend we look for volunteers to support our group action of cleaning the sideways and parks of plastic and other dirt. Looking forward to hearing from you." , capacity: 50 , category: "Environment" , ngo: ngo5)
file35 = File.open("app/assets/images/projects/trees.jpg")
project5.photo.attach(io: file35, filename: 'img5.jpg', content_type: 'image/jpg')

project6= Project.create(title: "Social work for homeless", hours_per_week: 6, address: "Carrer de Ferlandina, 20, 08001 Barcelona, Spain", description: "Everyday homeless people in Barcelona need food and shelter. We take care of them and provide them with basic food and drinks as well as prepare beds for overnight stay. We look for 3-5 people to support us during the week in the evenings" , capacity: 5 , category: "Social" , ngo: ngo6)
file36 = File.open("app/assets/images/projects/social-work.jpg")
project6.photo.attach(io: file36, filename: 'img6.jpg', content_type: 'image/jpg')


project7= Project.create(title: "Orphane Support Care Center", hours_per_week: 10, address: "Carrer de la Nació, 42, 08026 Barcelona, Spain", description: "This project aims to provide an opportunity for needy children and orphans to live and learn under one roof until they are adopted or integrated in the community or placed with family members who can take better care of them. Due to poverty, neglect and abuse, many children are forced to leave their homes without basic education.
